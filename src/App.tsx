...
const productCategories: Array<{ id: string; title: string; products: Product[] }> = [
  {
    ...
    products: [
      ...
      { name: "Kvadrat Klassisk", image: kvadratKlassiskVisualization, imageAlt: "Visualisering af Kvadrat Klassisk med blomster foreviget i epoxy", size: "18 × 18 × 6 cm", price: "Fra 2.995 kr.", description: "Et klassisk, harmonisk værk med god dybde og plads til både større blomster, flere detaljer og smukke lag.", imageIsVisualization: true },
