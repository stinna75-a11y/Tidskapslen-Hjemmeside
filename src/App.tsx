...
import logo from "./assets/Tidskapslen_Logo_Master_Laast.svg";
...
const selectProduct = (productName: string) => {
  ...
  const submitInquiry = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!supabase) {
      setFormStatus("error");
      setFormMessage(
        "Kontaktformularen er endnu ikke koblet til Supabase på denne installation."
      );
      return;
    }
  ...
  setFormMessage(error.message);
    ...
    setFormStatus("success");
    setFormMessage(
      "Tak. Din henvendelse er sendt til Tidskapslen. Jeg vender tilbage så hurtigt som muligt."
    );
    setForm({
      name: "",
      email: "",
...
>
  <img src={logo} alt="Tidskapslen logo" />
</button>

        <nav className="nav" aria-label="Hovedmenu">
          <button onClick={() => scrollTo("historien")}>Historien</button>
          <button onClick={() => scrollTo("anledninger")}>Anledninger</button>
          <button onClick={() => scrollTo("produkter")}>Produkter & priser</button>
          <button onClick={() => scrollTo("processen")}>Sådan foregår det</button>
      ...
      <main id="top">
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow">Minder · blomster · håndværk</p>
            <h1>
              Livets blomster.<br />
              <em>Foreviget i epoxy.</em>
            </h1>
            <p className="lead">
              Bevar blomsterne fra de øjeblikke, du aldrig vil glemme.
              Hvert værk skabes personligt og nænsomt med dine egne blomster.
            </p>
            <div className="hero-actions">
              <button className="primary" onClick={() => scrollTo("kontakt")}>
          ...
          <div className="hero-visual" aria-label="Eksempel på blomster foreviget i epoxy">
            <div className="hero-image-wrap">
              <img src={heroProduct} alt="Blomster bevaret i et elegant epoxyværk" />
            </div>
            <div className="hero-note">
              <span>Håndlavet</span>
              <strong>Ét minde. Ét unikt værk.</strong>
            </div>
          </div>
        </section>
        ...
        <section className="about-person section">
          <div className="about-person-content">
            ...
            <p>
              Resultatet skal ikke ligne noget, der er kommet fra en fabrik.
            </p>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="product-card-footer">
                  <h3>{product.name}</h3>{product.size && <p>{product.size}</p>}
{product.price && <strong>{product.price}</strong>}
        ...
        <section className="quote-band">
          <blockquote>
            “Det, vi holder af, behøver ikke forsvinde, bare fordi øjeblikket er forbi.”
          </blockquote>
        </section>
        ...
        <section id="faq" className="faq section">
          ...
          <div className="faq-grid">
            <article className="faq-card">
              ...
              <p>
                Jo friskere blomsterne er, når de kommer frem, desto bedre udgangspunkt har vi.
                Kontakt mig gerne så tidligt som muligt, så vi kan aftale den bedste løsning.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                Ja. Vi aftaler sammen, hvordan de pakkes og sendes mest nænsomt.
                Du får en enkel vejledning, så blomsterne er bedst muligt beskyttet under transporten.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                Naturlige blomster ændrer sig, når de tørres og bevares. Nuancer kan derfor ændre sig,
                og små variationer er en naturlig del af det håndlavede og unikke resultat.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                Mange blomster egner sig rigtig fint, men nogle arter og former kræver særlige hensyn.
                Jeg vurderer altid blomsterne individuelt. Hvis enkelte blomster eller plantedele ved modtagelsen
                er angrebet af råd eller mug, kraftigt nedbrudte eller på anden måde ikke egner sig til konservering,
                kan de blive frasorteret og kasseret for at beskytte kvaliteten af det færdige værk.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                Processen kan ikke forhastes. Blomsterne skal først tørres og klargøres,
                og epoxyarbejdet udføres i flere trin. Du får et realistisk forventet tidsforløb,
                når vi har talt om dit projekt.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                I mange tilfælde ja. Mulighederne afhænger af produktets størrelse og udformning.
                Vi aftaler altid personlige tilvalg sammen, før arbejdet sættes i gang.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                Nej. Når du sender kontaktformularen, starter du blot en uforpligtende dialog.
                Først når vi sammen har aftalt produkt, pris og detaljer, går vi videre.
              </p>
            </article>
            ...
            <article className="faq-card">
              ...
              <p>
                Nej – og det er netop en del af Tidskapslens idé. Blomsternes form, farve og placering
                gør hvert eneste værk til et unikt minde.
              </p>
            </article>
          </div>
          ...
          <div className="practical-note">
            ...
            <p>
              Små farveændringer, luftbobler og naturlige variationer kan forekomme.
              Det er ikke masseproduktion – det er håndværk, skabt omkring dine egne blomster.
            </p>
          </div>
        </section>
  ...
  <div className="selected-product-note">
    ...
    <span>Jeg hjælper dig gerne med mulighederne for netop dette værk.</span>
              ...
              <small className="form-note">
                Ved at sende formularen accepterer du, at Tidskapslen må kontakte
                dig om din forespørgsel. 
              </small>
            </form>
          </div>
        </section>

        <section id="juridisk" className="legal section">
          <div className="section-heading">
            <p className="eyebrow">Praktisk & juridisk</p>
            <h2>Tryghed og tydelige rammer.</h2>
            <p className="products-intro">
              Her finder du Tidskapslens handelsbetingelser, privatlivspolitik
              og information om cookies. Teksterne er skrevet til den måde,
              Tidskapslen arbejder på: personlige unika-værker og dialog før aftale.
            </p>
          </div>

          <div className="legal-grid">
            <article id="handelsbetingelser" className="legal-card">
              ...
              <p>
                En henvendelse via hjemmesiden er uforpligtende og udgør ikke en bindende bestilling.
                En aftale indgås først, når Tidskapslen og kunden skriftligt har aftalt det konkrete
                produkt, pris, eventuelle tilvalg, levering og øvrige relevante forhold.
              </p>

              <h4>3. Unika og naturmaterialer</h4>
              <p>
                Alle værker fremstilles individuelt med kundens egne blomster og andre aftalte materialer.
                Farver, form og udtryk kan ændre sig under tørring og indstøbning. Små luftbobler,
                nuanceforskelle og andre naturlige variationer kan forekomme og er en del af det håndlavede udtryk.
              </p>

              <h4>4. Pris og betaling</h4>
              <p>
                Den konkrete pris aftales før arbejdet påbegyndes. Eventuelle “fra-priser” er vejledende
                minimumspriser. Kunden informeres om den samlede aftalte pris og eventuelle leveringsomkostninger
                inden bindende aftale. Betalingsmetode og betalingstidspunkt fremgår af den konkrete ordrebekræftelse.
              </p>

              <h4>5. Levering og tidsforløb</h4>
              <p>
                Den normale leveringstid er ca. 3–4 måneder fra modtagelsen af blomsterne.
                Tidsforløbet kan variere afhængigt af blomsternes tilstand, tørretid, det valgte produkt
                og arbejdets omfang. Da processen består af flere håndværksmæssige trin, herunder tørring,
                klargøring og støbning, kan den ikke forhastes. Et forventet tidsforløb oplyses i forbindelse
                med den konkrete aftale. Forsinkelser kan forekomme, hvis materialerne kræver ekstra behandling,
                eller hvis uforudsete forhold opstår.
              </p>

              <h4>6. Kundens blomster og indleverede genstande</h4>
              <p>
                Kunden er ansvarlig for, at blomster og eventuelle personlige genstande er lovlige at sende og indlevere.
                Tidskapslen behandler materialerne så nænsomt som muligt, men naturmaterialer er skrøbelige,
                og resultatet afhænger af materialernes tilstand ved modtagelsen. Ved modtagelsen vurderer
                Tidskapslen blomsternes tilstand og egnethed til konservering og indstøbning. Tidskapslen
                forbeholder sig retten til at frasortere og kassere enkelte blomster eller plantedele,
                hvis de vurderes at være i en stand, hvor de ikke kan anvendes forsvarligt i det færdige værk,
                eksempelvis på grund af råd, mug, kraftig nedbrydning eller anden beskadigelse.
              </p>

              <h4>7. Fortrydelsesret og specialfremstillede varer</h4>
              <p>
                Da Tidskapslens værker fremstilles individuelt efter kundens specifikationer og med kundens egne blomster,
                kan reglerne om undtagelse fra den almindelige 14-dages fortrydelsesret for specialfremstillede eller
                tydeligt personlige varer være relevante. Kunden får oplysning om dette, før en bindende aftale indgås.
              </p>

              <h4>8. Reklamation</h4>
              <p>
                Hvis du mener, at der er en mangel ved det leverede værk, skal du kontakte Tidskapslen hurtigst muligt
                med en beskrivelse og gerne billeder. Dine ufravigelige rettigheder efter dansk forbrugerret gælder fortsat.
              </p>

              <h4>9. Tvister</h4>
              <p>
                Eventuelle uenigheder forsøges først løst i dialog. Oplysninger om relevant klageadgang tilføjes,
                når virksomhedens registrering og salgsmodel er endeligt fastlagt.
              </p>
            </article>

            <article id="privatlivspolitik" className="legal-card">
              ...
              <p>
                Vi kan behandle navn, e-mailadresse, telefonnummer, anledning, dato for begivenhed,
                produktinteresse, tilvalg og den besked, du selv skriver i kontaktformularen.
                Senere i kundeforløbet kan vi også behandle oplysninger, der er nødvendige for tilbud,
                aftale, betaling, levering og dokumentation.
              </p>

              <h4>3. Formål</h4>
              <p>
                Oplysningerne bruges til at besvare din henvendelse, rådgive dig om muligheder,
                udarbejde tilbud og – hvis du bliver kunde – administrere den aftalte ordre og kundedialog.
              </p>

              <h4>4. Retsgrundlag</h4>
              <p>
                Behandling i forbindelse med en konkret forespørgsel sker for at kunne besvare din henvendelse
                og tage skridt på din anmodning før en eventuel aftale. Oplysninger, der er nødvendige for en indgået aftale,
                behandles for at kunne opfylde aftalen. Eventuelle lovpligtige oplysninger opbevares efter gældende regler.
              </p>

              <h4>5. Opbevaring</h4>
              <p>
                Henvendelser opbevares kun så længe, det er relevant for dialogen og eventuel opfølgning.
                Kunde- og regnskabsoplysninger kan blive opbevaret længere, når lovgivningen kræver det.
                En mere præcis slettefrist fastsættes, før hjemmesiden lanceres offentligt.
              </p>

              <h4>6. Databehandlere og hosting</h4>
              <p>
                Hjemmesiden kan anvende tekniske leverandører til hosting og datalagring, herunder Vercel og Supabase.
                Disse leverandører behandler kun oplysninger som led i den tekniske drift og efter gældende databeskyttelseskrav.
              </p>

              <h4>7. Dine rettigheder</h4>
              <p>
                Du kan blandt andet have ret til indsigt, rettelse, sletning, begrænsning og indsigelse afhængigt af situationen.
                Du kan kontakte Tidskapslen via [indsæt e-mail]. Du kan også klage til Datatilsynet,
                hvis du mener, at dine personoplysninger behandles i strid med reglerne.
              </p>
            </article>

            <article id="cookiepolitik" className="legal-card">
              <p className="eyebrow">Cookiepolitik</p>
              <h3>Cookies på Tidskapslens hjemmeside</h3>

              <h4>1. Nødvendige tekniske funktioner</h4>
              <p>
                Den nuværende version af hjemmesiden er bygget uden markedsføringscookies og uden analyseværktøjer.
                Hvis hjemmesiden alene bruger teknisk nødvendige funktioner, kræves der som udgangspunkt ikke samtykke
                til statistik- eller markedsføringscookies, fordi sådanne cookies ikke sættes.
              </p>

              <h4>2. Hvis vi senere tilføjer statistik eller markedsføring</h4>
              <p>
                Hvis Tidskapslen senere tilføjer statistik, annoncering, Meta Pixel, Google Analytics
                eller andre ikke-nødvendige cookies eller lignende teknologier, vil der blive indført en
                samtykkeløsning, før disse teknologier aktiveres.
              </p>

              <h4>3. Ændringer</h4>
              <p>
                Cookiepolitikken opdateres, hvis hjemmesidens tekniske opsætning ændres.
              </p>
            </article>
          </div>
          </section>
      ...
      <footer className="footer">
        ...
        <div className="footer-links">
          <button onClick={() => scrollTo("produkter")}>Produkter & priser</button>
          <button onClick={() => scrollTo("handelsbetingelser")}>Handelsbetingelser</button>
          <button onClick={() => scrollTo("privatlivspolitik")}>Privatlivspolitik</button>
          <button onClick={() => scrollTo("cookiepolitik")}>Cookiepolitik</button>
        </div>
      </footer>
    </div>
  );
